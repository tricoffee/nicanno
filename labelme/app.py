...
class MainWindow(QtWidgets.QMainWindow):
    #filelist_trigger = QtCore.Signal([list,int])
    #filelist_trigger = QtCore.Signal(str)
    ...
    def importDirImages(self, dirpath, pattern=None, load=True):
        ...
        #xxx# self.filelist_trigger.connect(self.display_fnm)

        fnms = list_files(dirpath,SupportImageType)

        # 实例化线程对象
        self.work = FileListThread()
        # 线程自定义信号连接的槽函数
        self.work.trigger.connect(self.display_fnm)
        self.work.filenms = fnms
        self.work.filenum = len(fnms)
        ...
        #         continue
            ...
            #xxx# self.filelist_trigger.emit(filename)

            
            # 线程自定义信号连接的槽函数
            # self.work.trigger.connect(self.display_fnm)
            # self.work.filename = filename
    ...
    #def display_fnm(self,filename):
    def display_fnm(self,filenms,filenum):
...
class FileListThread(QtCore.QThread):
    ...
    def __int__(self):
        # 初始化函数
        super(FileListThread, self).__init__()
    ...
    def run(self):
        ...
        self.trigger.emit(self.filenms,self.filenum)
